...
\def\dmsqso        {\ensuremath{\Delta m^2_{21}}\xspace} 
...
\def\dmsq     {\ensuremath{\Delta m^{2}_{32}\xspace}}

\def\evsq     {\ensuremath{\rm \,eV^{2}\xspace}}
\def\dcp      {\ensuremath{\delta_{CP}}\xspace}

%%%%%%%%%% Oscillation fit %%%%%%%%%%%%%%%%%%%%%

%\def\sysp        {\ensuremath{\boldmath f}}
\def\sysp        {\ensuremath{\boldsymbol{f}}}
%\def\ofp        {\ensuremath{\mbox{\boldmath \theta}}} 
%\def\ofp        {\ensuremath{\boldmath \theta}} 
\def\ofp        {\ensuremath{\boldsymbol{o}}} 
%\def\ofp        {ofp}
...
\def\LLnorm        {\ensuremath{{\cal L}_{\textrm{norm}}}} 
\def\LLshape        {\ensuremath{{\cal L}_{\textrm{shape}}}} 
\def\LLsyst        {\ensuremath{{\cal L}_{\textrm{syst}}}} 
\def\ptheta   {\ensuremath{p-\theta}\xspace}
\def\pe        {p_{e}\xspace} 
\def\te        {\theta_{e}\xspace} 
\def\erec {\ensuremath{E_\nu^{rec}}\xspace}
\def\pthetae   {\ensuremath{p_e-\theta_e}\xspace}
...
\def\costmu     {\mbox{$\cos\theta_{\mu}$}\xspace}
...
\def\kton   {\ensuremath{\rm \,kton}\xspace}
\def\m3    {\ensuremath{{\rm \,m}^3}\xspace}
